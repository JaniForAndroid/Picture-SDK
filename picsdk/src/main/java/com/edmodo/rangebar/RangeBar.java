...
public class RangeBar extends View {
   ...
   *
   * @param thumbImageNormalID Integer specifying the resource ID of the image to be drawn as the
   * normal thumb.
   */
   ...
   *
   * @param thumbImagePressedID Integer specifying the resource ID of the image to be drawn as the
   * pressed thumb.
   */
   ...
   *
   * @param thumbColorNormal Integer specifying the normal color of the circle to be drawn.
   */
   ...
   *
   * @param thumbColorPressed Integer specifying the pressed color of the circle to be drawn.
   */
  ...
  private void rangeBarInit(Context context, AttributeSet attrs) {
    ...
    try {
      ...
      mThumbColorNormal = ta
          .getColor(R.styleable.RangeBar_thumbColorNormal, DEFAULT_THUMB_COLOR_NORMAL);
