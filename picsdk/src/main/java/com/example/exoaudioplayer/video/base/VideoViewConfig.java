...
public class VideoViewConfig {
    ...
    public final VideoPlayerFactory mPlayerFactory;
    ...
    private VideoViewConfig(Builder builder) {
        ...
        if (builder.mPlayerFactory == null) {
            ...
            mPlayerFactory = MediaPlayerFactory.getInstance();
        } else {
            mPlayerFactory = builder.mPlayerFactory;
        }
        if (builder.mRenderViewFactory == null) {
            //默认使用TextureView渲染视频
            mRenderViewFactory = CreateRenderViewFactory.getInstance();
        } else {
    ...
    public final static class Builder {
        ...
        private VideoPlayerFactory mPlayerFactory;
         ...
         * 自定义播放核心
         */
        public Builder setPlayerFactory(VideoPlayerFactory playerFactory) {
