...
public class ControlWrapperI implements IMediaPlayerControl, IVideoController {
  ...
  public ControlWrapperI(@NonNull IMediaPlayerControl playerControl, @NonNull IVideoController controller) {
  ...
  public long getDuration1() {
    return mPlayerControl.getDuration1();
  }

  @Override
  public long getSize() {
    return mPlayerControl.getSize();
  }
  ...
  public boolean isAlwaysFullScreen() {
    return mPlayerControl.isAlwaysFullScreen();
  }
