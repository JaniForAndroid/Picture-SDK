package com.example.exoaudioplayer.video.util;
...
public final class PlayerUtils {
  ...
  public static int sp2px(Context context, float dpValue) {
    return (int) TypedValue
        .applyDimension(TypedValue.COMPLEX_UNIT_SP, dpValue, context.getResources().getDisplayMetrics());
  }
...
//                case TelephonyManager.NETWORK_TYPE_NR:
  ...
  public static boolean isNetConnect(Context context) {
    return PlayerUtils.getNetworkType(context) != PlayerUtils.NETWORK_CLOSED
        && PlayerUtils.getNetworkType(context) != PlayerUtils.NO_NETWORK;
  }
}
