package com.example.picsdk.view.progress;
...
import com.example.picsdk.view.progress.utils.Constant;
import com.example.picsdk.view.progress.utils.MiscUtil;
...
//        canvas.drawText(String.format(mPrecisionFormat, mValue), mCenterPoint.x, mValueOffset, mValuePaint);
        //TODO 因为是倒计时 用最大值减一下
        canvas.drawText(String.format(mPrecisionFormat, mMaxValue - mValue) + "s", mCenterPoint.x, mValueOffset, mValuePaint);
        if (mHint != null) {
