 ...
 */
public class AndroidMediaPlayer implements OnCompletionListener, OnErrorListener, OnInfoListener,
    OnPreparedListener,
    OnSeekCompleteListener, OnVideoSizeChangedListener, OnBufferingUpdateListener {
  ...
  public void onPrepared(MediaPlayer mp) {
    ...
    if (VERSION_CODES.M <= Build.VERSION.SDK_INT && playbackParameters != null) {
  ...
  public AndroidMediaPlayer(int streamType, Callback callback) {
