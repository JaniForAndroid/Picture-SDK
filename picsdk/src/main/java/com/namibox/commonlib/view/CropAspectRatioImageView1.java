...
public class CropAspectRatioImageView1 extends AppCompatImageView {
  ...
  float width, height;
  public CropAspectRatioImageView1(Context context) {
    super(context);
    init(context, null);
  }

  public CropAspectRatioImageView1(Context context, AttributeSet attrs) {
    super(context, attrs);
    init(context, attrs);
  }

  public CropAspectRatioImageView1(Context context, AttributeSet attrs, int defStyleAttr) {
