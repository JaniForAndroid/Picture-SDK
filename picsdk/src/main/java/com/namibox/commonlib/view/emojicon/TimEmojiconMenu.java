...
import com.namibox.commonlib.view.emojicon.TimEmojiconPagerView.EaseEmojiconPagerViewListener;
import com.namibox.commonlib.view.emojicon.TimEmojiconScrollTabBar.EaseScrollTabBarItemClickListener;
...
public class TimEmojiconMenu extends TimEmojiconMenuBase {
  ...
  private void initDefault() {
    ...
    emojiconGroupList.add(new TimEmojiconGroupEntity(R.drawable.common_emoj_smile,
        Arrays.asList(TimDefaultEmojiconDatas.getData())));
