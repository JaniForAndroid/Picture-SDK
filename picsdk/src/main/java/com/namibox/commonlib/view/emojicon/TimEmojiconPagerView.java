...
import com.namibox.commonlib.view.emojicon.adapter.EmojiconGridAdapter;
import com.namibox.commonlib.view.emojicon.adapter.EmojiconPagerAdapter;
...
import com.namibox.commonlib.view.emojicon.domain.TimEmojiconGroupEntity;
  ...
  public List<View> getGroupGridViews(TimEmojiconGroupEntity groupEntity) {
    ...
    for (int i = 0; i < pageSize; i++) {
      ...
      if (emojiType != Type.BIG_EXPRESSION) {
        ...
        deleteIcon.setEmojiText(TimSmileUtils.DELETE_KEY);
        list.add(deleteIcon);
      }
      ...
      gv.setOnItemClickListener(new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
          ...
          if (pagerViewListener != null) {
            ...
            if (emojiText != null && emojiText.equals(TimSmileUtils.DELETE_KEY)) {
