...
public class AudioConstant {
  ...
  public static final int RecordSampleRate = 16000; // 采样率
  public static final int RecordByteNumber = 2; // 16bit/2
  ...
  public static final int BehaviorSampleRate = 16000; // 采样率
