  ...
  protected Result doInBackground(Void... params) {
    try {
      if (!isCancelled()) {
        ...
        if (mUri != null) {
          bitmap = BitmapUtils
              .cropBitmap(mContext, mUri, mCropPoints, mDegreesRotated, mOrgWidth, mOrgHeight,
                  mFixAspectRatio, mAspectRatioX, mAspectRatioY, mReqWidth, mReqHeight);
        } else if (mBitmap != null) {
          bitmap = BitmapUtils
              .cropBitmap(mBitmap, mCropPoints, mDegreesRotated, mFixAspectRatio, mAspectRatioX,
                  mAspectRatioY);
        }
        ...
        if (mSaveUri == null) {
          ...
          BitmapUtils.writeBitmapToUri(mContext, bitmap, mSaveUri, mSaveCompressFormat,
