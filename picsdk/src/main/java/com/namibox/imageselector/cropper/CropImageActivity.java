 ...
 */
public class CropImageActivity extends BaseBuryPointActivity implements
...
//        if (item.getItemId() == R.id.crop_image_menu_skip) {
//            setResult(null, null);
//            finish();
//            return true;
//        }
    if (item.getItemId() == R.id.crop_image_menu_restore) {
