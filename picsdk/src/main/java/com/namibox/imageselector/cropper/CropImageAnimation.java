...
final class CropImageAnimation extends Animation implements Animation.AnimationListener {
  ...
  protected void applyTransformation(float interpolatedTime, Transformation t) {
    ...
    mAnimRect.left =
        mStartImageRect.left + (mEndImageRect.left - mStartImageRect.left) * interpolatedTime;
    mAnimRect.top =
        mStartImageRect.top + (mEndImageRect.top - mStartImageRect.top) * interpolatedTime;
    mAnimRect.right =
        mStartImageRect.right + (mEndImageRect.right - mStartImageRect.right) * interpolatedTime;
    mAnimRect.bottom =
        mStartImageRect.bottom + (mEndImageRect.bottom - mStartImageRect.bottom) * interpolatedTime;
