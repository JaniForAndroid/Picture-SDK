...
public class SpecialLabelUnit extends BaseSpecialUnit {
  ...
  public SpecialLabelUnit(String specialText, int labelTextColor, float labelTextSize,
      int labelBgColor) {
    super(specialText);
  ...
  public SpecialLabelUnit(String specialText, int labelTextColor, float labelTextSize,
      int labelBgColor, int labelBgWidth, int labelBgHeight) {
    super(specialText);
    this.labelTextSize = labelTextSize;
    this.labelTextColor = labelTextColor;
    this.labelBgColor = labelBgColor;
  ...
  public SpecialLabelUnit(String specialText, int labelTextColor, float labelTextSize,
      Bitmap bitmap, int labelBgWidth, int labelBgHeight) {
    super(specialText);
    this.labelTextSize = labelTextSize;
    this.labelTextColor = labelTextColor;
    this.mBitmap = bitmap;
