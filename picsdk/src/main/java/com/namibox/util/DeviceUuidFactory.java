...
public class DeviceUuidFactory {
   ...
   * may change.  Or, if a user uninstalls your app on a device that has neither a proper Android ID
   * nor a Device ID, this ID may change on reinstallation.
   * <p/>
   * Note that if the code falls back on using TelephonyManager.getDeviceId(), the resulting ID will
   * NOT change after a factory reset.  Something to be aware of.
   * <p/>
