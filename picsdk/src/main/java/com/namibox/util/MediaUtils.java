...
public class MediaUtils {
  ...
  static Formatter mFormatter = new Formatter(sb, Locale.getDefault());
   ...
   *
   * @param uri must has {@link Uri#getScheme()} equals {@link ContentResolver#SCHEME_CONTENT}
  ...
  public static String getDurationString(Cursor c) {
    long durationMs = c.getLong(c.getColumnIndex(Video.VideoColumns.DURATION));
