...
public final class SystemUiHelper {
   ...
   * @param level The level of hiding. Should be either {@link #LEVEL_LOW_PROFILE}, {@link
   * #LEVEL_HIDE_STATUS_BAR}, {@link #LEVEL_LEAN_BACK} or {@link #LEVEL_IMMERSIVE}
   * @param flags Additional options. See {@link #FLAG_LAYOUT_IN_SCREEN_OLDER_DEVICES} and {@link
