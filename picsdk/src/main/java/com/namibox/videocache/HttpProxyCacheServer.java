...
import static com.namibox.videocache.Preconditions.checkAllNotNull;
import static com.namibox.videocache.Preconditions.checkNotNull;

import android.content.Context;
import android.net.Uri;
import com.namibox.util.Logger;
import com.namibox.videocache.file.DiskUsage;
import com.namibox.videocache.file.FileNameGenerator;
import com.namibox.videocache.file.Md5FileNameGenerator;
import com.namibox.videocache.file.TotalCountLruDiskUsage;
import com.namibox.videocache.file.TotalSizeLruDiskUsage;
...
public class HttpProxyCacheServer {
    ...
    public String getProxyUrl(String url, boolean allowCachedFileUri) {
        if (allowCachedFileUri && isCached(url)) {
            ...
            Logger.d("getProxyUrl, return file: " + cacheFile);
    ...
    public boolean isCached(String url) {
        ...
        try {
            ...
            Logger.d("getCacheFile(" + length + "):" + file.getAbsolutePath());
        } catch (Exception e) {
            e.printStackTrace();
        }
        return file.exists();
    ...
    private String appendToProxyUrl(String url) {
        String newUrl = String.format(Locale.US, "http://%s:%d/%s", PROXY_HOST, port,
            ProxyCacheUtils.encode(url));
        Logger.d("appendToProxyUrl: " + newUrl);
        return newUrl;
    }
    ...
    private void touchFileSafely(File cacheFile) {
        try {
            ...
            Logger.e("Error touching file " + cacheFile);
        }
    }
    ...
    private void waitForRequest() {
        try {
            while (!Thread.currentThread().isInterrupted()) {
                ...
                Logger.v("Accept new socket: " + socket);
    ...
    private void processSocket(Socket socket) {
        ...
        try {
            ...
            Logger.e("Closing socket by client: " + request);
        } catch (IOException e) {
            ...
            Logger.d("release Socket: " + request + ", Opened connections: " + getClientsCount());
        }
    }
    ...
    private void closeSocketOutput(Socket socket) {
        try {
            ...
            Logger.w("Failed to close socket on proxy side: " + e.getMessage() + ". It seems client have already closed connection.");
        }
    }
    ...
    public static final class Builder {
        ...
        public Builder(Context context,boolean isOnlyPath) {
            this.sourceInfoStorage = SourceInfoStorageFactory.newSourceInfoStorage(context);
            this.cacheRoot = StorageUtils.getIndividualCacheDirectory(context);
            this.diskUsage = new TotalSizeLruDiskUsage(DEFAULT_MAX_SIZE);
            this.fileNameGenerator = new Md5FileNameGenerator(isOnlyPath);
            this.headerInjector = new EmptyHeadersInjector();
        }
