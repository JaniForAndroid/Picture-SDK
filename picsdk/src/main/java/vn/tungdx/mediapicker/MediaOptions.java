...
/**
 * Contains all options for pick one or many photos, videos. Defines: <ul> <li>Can select many
 * photos or videos</li> <li>Crop photo or not. Can set file to save photo cropped. Can set ratio to
 * crop.</li> <li>Whether choose photo or video or both in picker.</li> <li>Set max, min duration of
 * video.</li> <li>Set show warning before record video.</li> </ul>
 * <p/>
 * Two methods to create instance : <ul> <li> <code>new {@link Builder}. {@link
 * Builder#canSelectMultiPhoto(boolean) canSelectMultiPhoto(boolean)}. {@link
 * Builder#setFixAspectRatio(boolean) setFixAspectRatio(boolean)}. {@link
 * Builder#setMaxVideoDuration(int) setMaxVideoDuration(int)}.{@link Builder#build() build()}<code>
 * </li> <li>or create default {@link #createDefault()}</li> </ul>
 */
public class MediaOptions implements Parcelable {
  ...
  public static class Builder {
    ...
    /**
     * @param file Use for save image that cropped. Default image cropped saved in file that created
     * by {@link Utils#createTempFile(android.content.Context)}
     * <p/>
     * <i>Note: file should not exist when pass to this method. Because if user cancels capture
     * photo, this file will be temporary.</i>
     */
    ...
    /**
     * @param file Use for save image that capture from camera. Default image saved in {@link
     * Environment#DIRECTORY_PICTURES} folder of device, file create by {@link
     * MediaUtils#createDefaultImageFile()}<br/> <b>Note:</b><br/> - File should not exist when pass
     * to this method. Because if use cancle capture photo, this file will be temporary.<br/> - In
     * HTC devices (maybe others) this options not true, image isn't saved in this file, it's saved
     * by folder default of camera.
     */
  ...
  public MediaOptions(Parcel in) {
    ...
    isOpenOther = in.readInt() == 0 ? false : true;
  ...
  public int hashCode() {
    ...
    result = prime * result + (isOpenOther ? 1231 : 1237);
  ...
  public boolean equals(Object obj) {
    ...
    if (isOpenOther != other.isOpenOther) {
      return false;
    }
    return true;
  }
